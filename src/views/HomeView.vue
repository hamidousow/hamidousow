          ...
          <div class="wrapper content">
              ...
              <div class="card-details">
                ...
                <div class="card-details-texts">
                  <h3 class="card-subtitle pixelify-font-medium">Moi c'est Hamidou</h3>
                  <p>Développeur frontend passionné</p>
                </div>
...
<style scoped>
  ...
  .grid__right .card-subtitle {
    font-size: clamp(21px, 2vw, 40px);
  }

  .grid__right .card-details {
    display: flex;
    flex-direction: column;
    column-gap: 20px;
  }

  .grid__right .card-details .line {
    margin-bottom: 15px;
    max-width: 100px;
  }

  .project-block .container-title {
    display: flex;
    height: 100%;
  }
  ...
  @media screen and (min-width:567px) {
    ...
    .grid__right .card-details .line[data-v-b4e148ca] {
      flex: 1;
        margin-top: 10px;
    }
